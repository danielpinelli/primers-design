...
ecoPCR -d $ECOPCRDAT -e $ecoPCR_e -L $ecoPCR_L $MS_DL1_F $MS_DL1_R > mullus_std_MS_DL1.ecopcr
ecoPCR -d $ECOPCRDAT -e $ecoPCR_e -L $ecoPCR_L $MS_DL2_F $MS_DL2_R > mullus_std_MS_DL2.ecopcr
ecoPCR -d $ECOPCRDAT -e $ecoPCR_e -L $ecoPCR_L $MS_DL3_F $MS_DL3_R > mullus_std_MS_DL3.ecopcr
ecoPCR -d $ECOPCRDAT -e $ecoPCR_e -L $ecoPCR_L $MS_DL4_F $MS_DL4_R > mullus_std_MS_DL4.ecopcr

ecoPCR -d $ECOPCRDAT -e $ecoPCR_e -L $ecoPCR_L $MS_DL5_F $MS_DL5_R > mullus_std_MS_DL5.ecopcr
ecoPCR -d $ECOPCRDAT -e $ecoPCR_e -L $ecoPCR_L $MS_DL6_F $MS_DL6_R > mullus_std_MS_DL6.ecopcr
ecoPCR -d $ECOPCRDAT -e $ecoPCR_e -L $ecoPCR_L $MS_DL7_F $MS_DL7_R > mullus_std_MS_DL7.ecopcr

ecoPCR -d $ECOPCRDAT -e $ecoPCR_e -L $ecoPCR_L $MS_DL8_F $MS_DL8_R > mullus_std_MS_DL8.ecopcr
ecoPCR -d $ECOPCRDAT -e $ecoPCR_e -L $ecoPCR_L $MS_DL9_F $MS_DL9_R > mullus_std_MS_DL9.ecopcr
ecoPCR -d $ECOPCRDAT -e $ecoPCR_e -L $ecoPCR_L $MS_DL10_F $MS_DL10_R > mullus_std_MS_DL10.ecopcr
ecoPCR -d $ECOPCRDAT -e $ecoPCR_e -L $ecoPCR_L $MS_DL11_F $MS_DL11_R > mullus_std_MS_DL11.ecopcr
